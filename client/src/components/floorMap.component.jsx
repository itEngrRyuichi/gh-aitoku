...
export default class FloorMap extends Component {
    ...
    thirdFloor() {
        ...
        canvasRoom301.width = 120;
        canvasRoom301.height = 120;
        canvasRoom301.style.width  = '120px';
        canvasRoom301.style.height = '120px';

        ctxRoom301.beginPath();
        ctxRoom301.moveTo(0, 0);
        ctxRoom301.lineTo(120, 0);
        ctxRoom301.lineTo(120, 120);
        ctxRoom301.lineTo(0, 120);
        ctxRoom301.closePath();
        ctxRoom301.lineWidth = 3;
        ctxRoom301.stroke(); 
        ctxRoom301.fillStyle = 'black';
        ctxRoom301.font = '18px Arial';
        ...
        canvasRoom302.width = 120;
        canvasRoom302.height = 120;
        canvasRoom302.style.width  = '120px';
        canvasRoom302.style.height = '120px';

        ctxRoom302.beginPath();
        ctxRoom302.moveTo(0, 0);
        ctxRoom302.lineTo(120, 0);
        ctxRoom302.lineTo(120, 120);
        ctxRoom302.lineTo(0, 120);
        ctxRoom302.closePath();
        ctxRoom302.lineWidth = 3;
        ctxRoom302.stroke(); 
        ctxRoom302.fillStyle = 'black';
        ctxRoom302.font = '18px Arial';
        ...
        canvasRoom303.width = 120;
        canvasRoom303.height = 120;
        canvasRoom303.style.width  = '120px';
        canvasRoom303.style.height = '120px';

        ctxRoom303.beginPath();
        ctxRoom303.moveTo(0, 0);
        ctxRoom303.lineTo(120, 0);
        ctxRoom303.lineTo(120, 120);
        ctxRoom303.lineTo(0, 120);
        ctxRoom303.closePath();
        ctxRoom303.lineWidth = 3;
        ctxRoom303.stroke(); 
        ctxRoom303.fillStyle = 'black';
        ctxRoom303.font = '18px Arial';

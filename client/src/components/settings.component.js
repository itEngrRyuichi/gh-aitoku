...
export default class Settings extends Component {
    ...
    componentDidMount() {
        ...
        this.getStayChild();
        this.getStayBaby();
        axios.get('https://aitoku-server.herokuapp.com/rooms/priorityFour')
        .then(response => {
        ...
        axios.get('https://aitoku-server.herokuapp.com/rooms/priorityFive')
        .then(response => {
        ...
        axios.get('https://aitoku-server.herokuapp.com/rooms/priorityTwo')
        .then(response => {
    ...
    getBreakfastAdult() {
        axios.get('https://aitoku-server.herokuapp.com/prices/5faca682803cf55ec0675073')
        .then(response => {
    ...
    getBreakfastMiddle() {
        axios.get('https://aitoku-server.herokuapp.com/prices/5faca6ea803cf55ec0675074')
        .then(response => {
    ...
    getBreakfastChild() {
        axios.get('https://aitoku-server.herokuapp.com/prices/5faca717803cf55ec0675075')
        .then(response => {
    ...
    getBreakfastBaby() {
        axios.get('https://aitoku-server.herokuapp.com/prices/5faca739803cf55ec0675076')
        .then(response => {
    ...
    getStayAdult() {
        axios.get('https://aitoku-server.herokuapp.com/prices/5faca770803cf55ec0675077')
        .then(response => {
    ...
    getStayMiddle() {
        axios.get('https://aitoku-server.herokuapp.com/prices/5faca77f803cf55ec0675078')
        .then(response => {
    ...
    getStayChild() {
        axios.get('https://aitoku-server.herokuapp.com/prices/5faca78e803cf55ec0675079')
        .then(response => {
    ...
    getStayBaby() {
        axios.get('https://aitoku-server.herokuapp.com/prices/5faca798803cf55ec067507a')
        .then(response => {
    ...
    onPriceSubmit(e) {
        ...
        axios.post('https://aitoku-server.herokuapp.com/prices/update/5faca682803cf55ec0675073', { title:'breakfast_adult', amount:this.state.breakfast_adult})
            .then(res => console.log(res.data));
        axios.post('https://aitoku-server.herokuapp.com/prices/update/5faca6ea803cf55ec0675074', { title:'breakfast_middle',  amount:this.state.breakfast_middle})
            .then(res => console.log(res.data));
        axios.post('https://aitoku-server.herokuapp.com/prices/update/5faca717803cf55ec0675075', { title:'breakfast_child',  amount:this.state.breakfast_child})
            .then(res => console.log(res.data));
        axios.post('https://aitoku-server.herokuapp.com/prices/update/5faca739803cf55ec0675076', { title:'breakfast_baby',  amount:this.state.breakfast_baby})
            .then(res => console.log(res.data));
        axios.post('https://aitoku-server.herokuapp.com/prices/update/5faca770803cf55ec0675077', { title:'stay_adult',  amount:this.state.stay_adult})
            .then(res => console.log(res.data));
        axios.post('https://aitoku-server.herokuapp.com/prices/update/5faca77f803cf55ec0675078', { title:'stay_middle',  amount:this.state.stay_middle})
            .then(res => console.log(res.data));
        axios.post('https://aitoku-server.herokuapp.com/prices/update/5faca78e803cf55ec0675079', { title:'stay_child',  amount:this.state.stay_child})
            .then(res => console.log(res.data));
        axios.post('https://aitoku-server.herokuapp.com/prices/update/5faca798803cf55ec067507a', { title:'stay_baby',  amount:this.state.stay_baby})
            .then(res => console.log(res.data));
    ...
    moveToUp(id, priority) {
        ...
        // 上のリストを今のリストに
        axios.post('https://aitoku-server.herokuapp.com/rooms/changetodown/', { priority: upperPriority }) 
            .then(res => console.log(res.data));
        // 今のリストを上に
        axios.post('https://aitoku-server.herokuapp.com/rooms/movedtoup/'+id, { priority }) 
            .then(res => console.log(res.data));
    ...
    moveToDown(id, priority) {
        ...
        // 下のリストを今のリストに
        axios.post('https://aitoku-server.herokuapp.com/rooms/changetoup/', { priority: downerPriority }) 
            .then(res => console.log(res.data));
        // 今のリストを下に
        axios.post('https://aitoku-server.herokuapp.com/rooms/movedtodown/'+id, { priority }) 
            .then(res => console.log(res.data));
        window.location = '/admin/settings';
    }

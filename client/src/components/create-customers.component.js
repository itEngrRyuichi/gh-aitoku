...
export default class CreateCustomers extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('https://aitoku-server.herokuapp.com/customers/add', customer) 
    ...
    getReserveRooms() {
        ...
        axios.get('https://aitoku-server.herokuapp.com/schedule/getReservedRooms', { params: params })
        .then(response => {
            const reserveRooms = [];
    ...
    getAvailableRooms(capacity, room) {
        ...
        axios.get('https://aitoku-server.herokuapp.com/schedule/availRooms', { params: params })
        .then(response => {
